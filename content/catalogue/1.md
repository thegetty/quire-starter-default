...
Several Lange images from the same photoshoot with Owens and her children exist in other collections. These give us the chance to consider the {% annoref fig='cat-1-b' text='many' %} {% annoref fig='cat-1-c' text='varied' %} choices in composition that Lange made in producing her iconic final image.
